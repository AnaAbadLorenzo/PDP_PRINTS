...
function escogeTamanho(entidad){
    ...
    switch(entidad){
        ...
        break;
        case 'PARAMETRO' :
            tamanho = tamanhoPaginaParametro;
        break;
        case 'PLAN' :
        ...
        break;
        case 'PROCESOSUSUARIOEJECUTADOS' :
    ...
    switch(entidad){
        ...
        case 'PARAMETRO':
            switch(funcionalidad){
                case 'cargarParametros': 
                    for(var i = 0; i< 3; i++){
                        paginas += '<li id="' + (i+1) + '" class="page-item boton' + (i+1) + '" style="display:block"><a class="page-link" href="#" onclick="cargarParametros(' 
                            + (i+1) + ',' + tamanhoPaginaParametro + ', \'PaginadorNo\' ); activarElemento(' + (i+1) +'); cargarPermisosSegunEntidad(getCookie(\'entidad\')); comprobarOcultos()">' + (i+1) + '</a></li>';
                    }
                break;
                case 'buscarParametro' : 
                    for(var i = 0; i< 3; i++){
                        paginas += '<li id="' + (i+1) + '" class="page-item boton' + (i+1) + '" style="display:block"><a class="page-link" href="#" onclick="buscarParametro(' 
                            + (i+1) + ',' + tamanhoPaginaParametro + ", \'buscarPaginacion\'" + '); activarElemento(' + (i+1) +'); cargarPermisosSegunEntidad(getCookie(\'entidad\')); comprobarOcultos()">' + (i+1) + '</a></li>';
                    }
                break;
        }
        break;
        ...
        case 'PROCESO':
            switch(funcionalidad){
                ...
                break;
                case 'cargarProcesosSegunCategoria' :
                    for(var i = 0; i< 3; i++){
                        paginas += '<li id="' + (i+1) + '" class="page-item boton' + (i+1) + '" style="display:block"><a class="page-link" href="#" onclick="cargarProcesosSegunCategoria(' 
                            + (i+1) + ',' + tamanhoPaginaProceso+ '); activarElemento(' + (i+1) +'); cargarPermisosSegunEntidad(getCookie(\'entidad\')); comprobarOcultos()">' + (i+1) + '</a></li>';
                    }
                break;
        ...
        case 'PROCESOSUSUARIOEJECUTADOS' :
            switch(funcionalidad){
                case 'cargarProcesosUsuarioEjecutados': 
                    for(var i = 0; i< 3; i++){
                        paginas += '<li id="' + (i+1) + '" class="page-item boton' + (i+1) + '" style="display:block"><a class="page-link" href="#" onclick="cargarProcesosUsuarioEjecutados(' 
                ...
                break;
                case 'buscarProcesosEjecutados' : 
                    for(var i = 0; i< 3; i++){
                        paginas += '<li id="' + (i+1) + '" class="page-item boton' + (i+1) + '" style="display:block"><a class="page-link" href="#" onclick="buscarProcesosEjecutados(' 
                            + (i+1) + ',' + tamanhoPaginaProcesosEjecutados + ", \'buscarPaginacion\'" + '); activarElemento(' + (i+1) +'); cargarPermisosSegunEntidad(getCookie(\'entidad\')); comprobarOcultos()">' + (i+1) + '</a></li>';
                    }
                break;
            }
            break;
